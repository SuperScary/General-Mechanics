package fluxmachines.core.compat.jei.categories;
...
public class MatterFabricatorCategory implements IRecipeCategory<FabricationRecipe> {
    public static final ResourceLocation UID = FluxMachines.getResource("refabrication");
    public static final ResourceLocation TEXTURE = FluxMachines.getResource("textures/gui/matter_fabricator.png");
