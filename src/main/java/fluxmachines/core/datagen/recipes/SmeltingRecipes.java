...
public class SmeltingRecipes extends CoreRecipeProvider {
    ...
    public @NotNull String getName () {
        return FluxMachines.NAME + " Smelting Recipes";
    }
    ...
    public void buildRecipes (@NotNull RecipeOutput consumer) {
        SimpleCookingRecipeBuilder
                ...
                .save(consumer, FluxMachines.getResource("smelting/drakium_ingot_from_raw_drakium_ore"));
        ...
        SimpleCookingRecipeBuilder
                ...
                .save(consumer, FluxMachines.getResource("smelting/drakium_block_from_raw_drakium_block"));
        ...
        SimpleCookingRecipeBuilder
                ...
                .save(consumer, FluxMachines.getResource("smelting/vanadium_ingot_from_raw_vanadium_ore"));
    }
