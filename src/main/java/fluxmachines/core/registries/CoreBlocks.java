...
import fluxmachines.core.api.block.ice.Ice7Block;
...
import fluxmachines.core.api.item.base.BaseBlockItem;
...
public class CoreBlocks {
    ...
    public static <T extends Block> BlockDefinition<T> reg (final String name, final Supplier<T> supplier) {
        ...
        return reg(name, FluxMachines.getResource(resourceFriendly), supplier, null, true);
    }

    public static <T extends Block> BlockDefinition<T> reg (final String name, String resourceName, final Supplier<T> supplier) {
        return reg(name, FluxMachines.getResource(resourceName), supplier, null, true);
    }
