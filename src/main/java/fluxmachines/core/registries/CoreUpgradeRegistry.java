...
import fluxmachines.core.api.upgrade.DeferredUpgradeMap;
...
import static fluxmachines.core.registries.CoreUpgrades.*;
...
public class CoreUpgradeRegistry {
    ...
    public static final DeferredRegister<UpgradeMap<?>> REGISTRY = DeferredRegister.create(CoreRegistries.UPGRADE_MAP_REGISTRY, FluxMachines.MODID);
