...
public enum TransistorType {
    ...
    N_CHANNEL_MOSFET("N-Channel MOSFET", "NMOS", "MOSFET", "Switching or low-side fePerTick control"),
    ...
    IGBT("Insulated-Gate Bipolar Transistor", "IGBT", "Hybrid", "High-voltage, high-current fePerTick switching"),
