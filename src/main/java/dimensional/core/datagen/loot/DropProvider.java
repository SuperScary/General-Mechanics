package dimensional.core.datagen.loot;
...
public class DropProvider extends BlockLootSubProvider {
    ...
    protected @NotNull Iterable<Block> getKnownBlocks() {
        return BuiltInRegistries.BLOCK.stream().filter(entry -> entry.getLootTable().location().getNamespace().equals(DimensionalCore.MODID))
                .toList();
    }
